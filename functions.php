 ...
 */
function acomer_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on acomer, use a find and replace
		* to change 'acomer' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'acomer', get_template_directory() . '/languages' );
 ...
 */
function acomer_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'acomer_content_width', 640 );
}
add_action( 'after_setup_theme', 'acomer_content_width', 0 );
 ...
 */
function acomer_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'acomer' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'acomer' ),
...
add_action( 'widgets_init', 'acomer_widgets_init' );
...
function acomer_scripts() {
	...
	wp_enqueue_style( 'menu-style', get_template_directory_uri() . '/ssets/css/menu.css', array(), _S_VERSION );
...
add_action( 'wp_enqueue_scripts', 'acomer_scripts' );
