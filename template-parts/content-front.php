                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-7 order-1 order-lg-0">
                            <div class="text-area">
                                <h1 class="wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1s">We Design Amazing App Prototypes</h1>
                                <h1 class="wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">For Startups</h1>
